...
int main(int argc, char *argv[])
{
	...
	remove("/data/data/com.gesture.recordinator/files/getevent.output");
	usleep(1*1000*1000);
	pFile = fopen("/data/data/com.gesture.recordinator/files/getevent.output", "w");
